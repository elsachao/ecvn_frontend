        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div>
            ...
            <input
              type="date"
              value={appInfo.date}
              onChange={(e: any) => setAppInfo({ date: e.target.value })}
          ...
          <div>
            ...
            <input
              type="text"
              value={appInfo.taxId}
              onChange={(e: any) => setAppInfo({ taxId: e.target.value })}
              placeholder="請輸入 8 碼"
              className="w-full bg-white border border-slate-300 rounded-lg px-4 py-2.5 text-slate-700 font-mono focus:border-blue-500 outline-none"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e: any) => setAppInfo({ agentName: e.target.value })}
          ...
          <div>
            ...
            <select
              value={appInfo.type}
              onChange={(e: any) => setAppInfo({ type: e.target.value })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e: any) => setAppInfo({ status: e.target.value })}
